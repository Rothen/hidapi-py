...
from .crc32 import compute_crc32_checksum
from .enums import OutReportLength, LightbarMode
...
class Bt31OutReport(OutReport):
    def data(self) -> bytes:
        ...
        out_report_bytes[19] = self.right_trigger_effect_param7
        out_report_bytes[20] = self.right_trigger_effect_param8
        out_report_bytes[21] = self.right_trigger_effect_param9
        out_report_bytes[22] = self.right_trigger_effect_param10
        ...
        out_report_bytes[30] = self.left_trigger_effect_param7
        out_report_bytes[31] = self.left_trigger_effect_param8
        out_report_bytes[32] = self.left_trigger_effect_param9
        out_report_bytes[33] = self.left_trigger_effect_param10
